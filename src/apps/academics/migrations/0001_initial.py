    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parcours",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="promotions", to="formations.parcours"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "formule_tarif",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="formations.tarif"
                    ),
                ),
                (
                    "parcours",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="etudiants", to="formations.parcours"
                    ),
                ),
                (
                    "utilisateur",
                ...
                (
                    "promotion",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="etudiants", to="academics.promotion"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="academics.sessionacademique",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(choices=[("iteag", "ITEAG"), ("flte", "FLTE")], default="iteag", max_length=10),
                ),
                ("date_validation", models.DateField()),
                (
                    "cours",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="formations.cours"
                    ),
                ),
                (
                    "etudiant",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cours",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="sessions", to="formations.cours"
                    ),
                ),
                (
                    "enseignant",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "statut",
                    models.CharField(
                        choices=[("en_cours", "En cours"), ("valide", "Validé"), ("non_valide", "Non validé")],
                        default="en_cours",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ects_accordes",
                    models.DecimalField(decimal_places=1, default=0, max_digits=5, verbose_name="ECTS accordés"),
                ),
                (
                    "statut",
                    models.CharField(
                ...
                (
                    "etudiant",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="vaes", to="academics.profiletudiant"
                    ),
                ),
            ],
            options={
