...
class Command(BaseCommand):
    ...
    def _seed_disciplines(self):
        data = [
            {
                "nom": "Ancien Testament",
                "ordre": 1,
                "description": "Étude des textes de l'Ancien Testament : Pentateuque, livres historiques, poétiques et prophétiques. Exégèse, théologie et contexte historique.",
            },
            {
                "nom": "Nouveau Testament",
                "ordre": 2,
                "description": "Étude des Évangiles, des Actes, des Épîtres et de l'Apocalypse. Exégèse, contexte gréco-romain et théologie néotestamentaire.",
            },
            {
                "nom": "Théologie systématique",
                "ordre": 3,
                "description": "Doctrine chrétienne : théologie propre, christologie, pneumatologie, sotériologie, ecclésiologie, eschatologie. Aussi appelée « doctrine ».",
            },
            {
                "nom": "Histoire de l'Église",
                "ordre": 4,
                "description": "Des origines à nos jours : Pères de l'Église, Réforme, mouvements évangéliques, histoire du christianisme dans la Caraïbe et aux Antilles-Guyane.",
            },
            {
                "nom": "Théologie pratique",
                "ordre": 5,
                "description": "Homilétique, pastorale, counseling, leadership ecclésial, missiologie, éthique chrétienne et accompagnement spirituel.",
            },
        ]
        for d in data:
    ...
    def _seed_parcours(self):
        data = [
            ...
            },
            {
                ...
                "conditions_entree": ("Aucune condition d'entrée.\nOuvert à tous.\nChoix des sessions possible."),
    ...
    def _seed_cours(self):
        ...
        cours_data = [
            # Ancien Testament
            {
                ...
                "code": "AT-101",
                "discipline": "ancien-testament",
                "description": "Survol de l'Ancien Testament : contexte historique, littéraire et théologique. Présentation des grands thèmes et de la structure canonique.",
            },
            {
                "titre": "Pentateuque",
                "code": "AT-201",
                "discipline": "ancien-testament",
                "description": "Étude approfondie des cinq livres de Moïse : Genèse, Exode, Lévitique, Nombres, Deutéronome. Questions d'auteur, de date et de théologie.",
            },
            {
                "titre": "Livres prophétiques",
                "code": "AT-301",
                "discipline": "ancien-testament",
                "description": "Étude des prophètes majeurs et mineurs. Contexte historique, message prophétique et pertinence contemporaine.",
            },
            {
                "titre": "Livres poétiques et sapientiaux",
                "code": "AT-302",
                "discipline": "ancien-testament",
                "description": "Job, Psaumes, Proverbes, Ecclésiaste, Cantique des Cantiques. Genres littéraires et sagesse biblique.",
            },
            # Nouveau Testament
            {
                "titre": "Introduction au Nouveau Testament",
                "code": "NT-101",
                "discipline": "nouveau-testament",
                "description": "Survol du Nouveau Testament : contexte gréco-romain, judaïsme du Second Temple, questions d'introduction.",
            },
            {
                "titre": "Évangiles synoptiques",
                "code": "NT-201",
                "discipline": "nouveau-testament",
                "description": "Étude comparative de Matthieu, Marc et Luc. Problème synoptique, critique rédactionnelle, théologie de chaque évangéliste.",
            },
            {
                "titre": "Épîtres pauliniennes",
                "code": "NT-301",
                "discipline": "nouveau-testament",
                "description": "Étude des lettres de Paul : Romains, Corinthiens, Galates, Éphésiens, etc. Théologie paulinienne et contexte ecclésial.",
            },
            {
                "titre": "Évangile et Épîtres de Jean",
                "code": "NT-302",
                "discipline": "nouveau-testament",
                "description": "Le corpus johannique : quatrième évangile, 1-3 Jean, Apocalypse. Théologie johannique.",
            },
            # Théologie systématique
            {
                "titre": "Théologie propre et christologie",
                "code": "TS-101",
                "discipline": "theologie-systematique",
                "description": "Doctrine de Dieu (attributs, trinité) et doctrine du Christ (personne et œuvre).",
            },
            {
                "titre": "Sotériologie et pneumatologie",
                "code": "TS-201",
                "discipline": "theologie-systematique",
                "description": "Doctrine du salut et doctrine du Saint-Esprit. Justification, sanctification, dons spirituels.",
            },
            {
                "titre": "Ecclésiologie et eschatologie",
                "code": "TS-301",
                "discipline": "theologie-systematique",
                "description": "Doctrine de l'Église et des derniers temps. Nature de l'Église, sacrements, retour de Christ.",
            },
            # Histoire de l'Église
            {
                "titre": "Histoire de l'Église ancienne",
                "code": "HE-101",
                "discipline": "histoire-de-leglise",
                "description": "Des origines au Moyen Âge : Pères apostoliques, conciles, développement de la doctrine, christianisation de l'Empire romain.",
            },
            {
                "titre": "Réforme et post-Réforme",
                "code": "HE-201",
                "discipline": "histoire-de-leglise",
                "description": "Luther, Calvin, Zwingli, Réforme radicale. Contre-Réforme, orthodoxie protestante, piétisme, revivalisme.",
            },
            {
                "titre": "Histoire du christianisme dans la Caraïbe",
                "code": "HE-301",
                "discipline": "histoire-de-leglise",
                "description": "Christianisation des Antilles, missions protestantes, mouvements évangéliques caribéens, histoire de l'Église aux Antilles-Guyane.",
            },
            # Théologie pratique
            {
                "titre": "Homilétique",
                "code": "TP-101",
                "discipline": "theologie-pratique",
                "description": "Art de la prédication : préparation, structure, communication, illustration. Exercices pratiques de prédication.",
            },
            {
                "titre": "Pastorale et counseling",
                "code": "TP-201",
                "discipline": "theologie-pratique",
                "description": "Accompagnement pastoral : visites, counseling biblique, gestion de conflits, soin des âmes.",
            },
            {
                "titre": "Leadership ecclésial et missiologie",
                "code": "TP-301",
                "discipline": "theologie-pratique",
                "description": "Direction d'Église, gestion d'équipe, vision missionnaire, implantation d'Églises, contexte caribéen.",
            },
            {
                "titre": "Éthique chrétienne",
                "code": "TP-302",
                "discipline": "theologie-pratique",
                "description": "Fondements bibliques de l'éthique, questions contemporaines, bioéthique, éthique sociale et politique.",
            },
        ]
