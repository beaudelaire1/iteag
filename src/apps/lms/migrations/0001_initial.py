    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fichier_soumis",
                    models.FileField(blank=True, upload_to="lms/devoirs/%Y/%m/", verbose_name="Fichier remis"),
                ),
                ...
                (
                    "ects_valides",
                    models.DecimalField(
                        decimal_places=1, default=0, help_text="0 ou 2.5", max_digits=4, verbose_name="ECTS validés"
                    ),
                ),
