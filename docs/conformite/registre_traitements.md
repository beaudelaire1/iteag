...
| Lettre d'information | abonnés | email, confirmation, désinscription | envoyer les informations demandées et prouver le consentement | consentement | secrétariat / communication | pendant l'abonnement ; preuve minimale d'opposition 3 ans après désinscription | `apps/core/models.py` |
...
| Témoignages étudiants | étudiants volontaires | nom, promotion, texte, photo éventuelle, consentement, statut | publier un témoignage choisi par l'étudiant | consentement | direction pour validation ; public après publication | publication jusqu'au retrait ; preuve minimale du consentement et du retrait conservable 3 ans | `apps/website/models_publications.py` / témoignages |
...
- pas de communication à un tiers sans base spécifique appropriée ;
- vérification de l'applicabilité de l'article 9(2)(d) du RGPD aux traitements réalisés dans le cadre des activités légitimes de l'association religieuse/non lucrative ;
- si une finalité sort de ce cadre, définir avant traitement l'exception de l'article 9 applicable, notamment le consentement explicite lorsqu'il est requis.
